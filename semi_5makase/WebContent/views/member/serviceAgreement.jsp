...
여러분을 환영합니다.
이눔세끼 서비스 및 제품(이하 ‘서비스’)을 이용해 주셔서 감사합니다. 본 약관은 다양한 이눔세끼 서비스의 이용과 관련하여 이눔세끼 서비스를 제공하는 이눔세끼 주식회사(이하 ‘이눔세끼’)와 이를 이용하는 이눔세끼 서비스 회원(이하 ‘회원’) 또는 비회원과의 관계를 설명하며, 아울러 여러분의 이눔세끼 서비스 이용에 도움이 될 수 있는 유익한 정보를 포함하고 있습니다.
                            
이눔세끼 서비스를 이용하시거나 이눔세끼 서비스 회원으로 가입하실 경우 여러분은 본 약관 및 관련 운영 정책을 확인하거나 동의하게 되므로, 잠시 시간을 내시어 주의 깊게 살펴봐 주시기 바랍니다.
                            
다양한 이눔세끼 서비스를 즐겨보세요.
이눔세끼는 www.naver.com을 비롯한 이눔세끼 도메인의 웹사이트 및 응용프로그램(어플리케이션, 앱)을 통해 정보 검색, 다른 이용자와의 커뮤니케이션, 콘텐츠 제공, 상품 쇼핑 등 여러분의 생활에 편리함을 더할 수 있는 다양한 서비스를 제공하고 있습니다.
여러분은 PC, 휴대폰 등 인터넷 이용이 가능한 각종 단말기를 통해 각양각색의 이눔세끼 서비스를 자유롭게 이용하실 수 있으며, 개별 서비스들의 구체적인 내용은 각 서비스 상의 안내, 공지사항, 이눔세끼 웹고객센터(이하 ‘고객센터’) 도움말 등에서 쉽게 확인하실 수 있습니다                        
                        </textarea><br><br>
                    </div>
                    ...
                    <div class="input_check">
                        ...
                        <textarea name="content" cols="50" rows="5" class="textarea"  readonly>
개인정보보호법에 따라 이눔세끼에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간, 동의 거부권 및 동의 거부 시 불이익에 관한 사항을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.

1. 수집하는 개인정보
이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 이눔세끼 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 이눔세끼는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.
                            
회원가입 시점에 이눔세끼가 이용자로부터 수집하는 개인정보는 아래와 같습니다.
...
- 단체 회원가입 시 필수 항목으로 단체아이디, 비밀번호, 단체이름, 이메일주소, 휴대전화번호를, 선택항목으로 단체 대표자명을 수집합니다.
                    ...
                    <div class="input_check">
                        ...
                        <textarea name="content" cols="50" rows="5" class="textarea" readonly>
                            이눔세끼 서비스 및 제휴 이벤트・혜택 등의 정보를 휴대전화(이눔세끼앱 알림 또는 문자), 이메일로 받을 수 있습니다. 일부 서비스(별개의 회원 체계 운영, 이눔세끼 가입 후 추가 가입하는 서비스 등)의 경우, 수신에 대해 별도로 안내드리며 동의를 구합니다.                           
                        </textarea>
                    </div>
            </div>
