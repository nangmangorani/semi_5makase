            ...
            <form action="">
                ...
                <div id="content_2" style="margin-top: 30px;">  
                    ...
                    <div align="center">   
                        <table>
                            <tr>
                                <td><img src="../views/resources/img/logo.png" alt=""></td>
                            ...
                            <tr>
                                <td>카테고리</td>
                                <td><input type="text" name="" id=""></td>
                                <td><button onclick="addCategory();">추가</button></td>
                            </tr>
                ...
                <div align="right" style="margin: 5px;">
                    <button type="button" class="btn btn-sm btn-secondary">취소하기</button>
                    <button type="sub" class="btn btn-sm btn-primary">등록하기</button>
                </div>
