    ...
    <div class="outline">
        ...
        <div class="content">
            ...
            <div id="content_2"> 
                        ...
                        <tbody>
							...
							<% } else { %>
	                        	...
	                        	<% for(AdminUpdateRestaurant rest : list) { %>
		                            <tr>
		                                <th scope="row" style="width: 15px"><%= rest.getUpdateNo() %></th>
		                                <td style="width: 100px"><%= rest.getRest() %></td>
		                                <td style="width: 250px"><%= rest.getUpdateContent() %></td>
		                                <td style="display: none;"><%= rest.getRestNo() %></td>
		                            </tr>
                            	<% } %>
                            <% } %>
                        </tbody>
	        	...
	        	<% if(currentPage != 1) { %>
	            	<button class="btn btn-primary" onclick="location.href='<%= contextPath %>/rtCangeList.ad?cpage=<%= currentPage - 1 %>'">&lt;</button>
	            <% } %>
	            ...
	            <% for(int p=startPage; p<=endPage; p++) { %>
	            	...
	            	<% } else { %>
	            		<button class="btn btn-primary" onclick="location.href='<%= contextPath %>/rtCangeList.ad?cpage=<%= p %>'"><%= p %></button>
	            	<% } %>
	            <% } %>
