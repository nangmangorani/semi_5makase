...
<%
	...
	ArrayList<AdminRestaurant> list = (ArrayList<AdminRestaurant>)request.getAttribute("list");
...
<body>
    ...
    <div class="outline">
        ...
        <div class="content">
            <div id="content_1">
                <h4 style="font-weight: bold;" align="center">음식점 관리</h4>
            </div>
            <div id="content_2"> 
                <div align="right" style="margin: 5px; margin-right: 30px ">
                    <a type="button" class="btn btn-sm btn-secondary" href="<%= contextPath %>/rtAddForm.ad">음식점 등록</a>
                </div>
                <div>
                    <table class="table" id="list-table">
                        ...
                        <tbody>
			                ...
			                <% if(list.isEmpty()) { %>
				                <tr>
				                    <td colspan="5">존재하는 음식점이 없습니다.</td>
				                </tr>
							<% } else { %>
					            <!-- case2. 공지글이 있을 경우 -->
            ...
            <div class="paging-area" align="center">
	        	<% if(currentPage != 1) { %>
	            	<button class="btn btn-primary" onclick="location.href='<%= contextPath %>/rtList.ad?cpage=<%= currentPage - 1 %>'">&lt;</button>
	            <% } %>
	            ...
	            <% for(int p=startPage; p<=endPage; p++) { %>
	            	...
	            	<% } else { %>
	            		<button class="btn btn-primary" onclick="location.href='<%= contextPath %>/rtList.ad?cpage=<%= p %>'"><%= p %></button>
	            	<% } %>
	            <% } %>
