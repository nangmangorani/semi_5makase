...
public class RestaurantService {
	...
	public ArrayList<AdminRestaurant> adminSelectRestRequest() {
		
		Connection conn = getConnection();
		
		ArrayList<AdminRestaurant> list = new RestaurantDao().adminSelectRestRequest(conn);
	...
	public ArrayList<AdminUpdateRestaurant> adminSelectRestChange() {
			
			Connection conn = getConnection();
			
			ArrayList<AdminUpdateRestaurant> list = new RestaurantDao().adminSelectRestChange(conn);
